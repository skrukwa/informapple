class StepCards extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <link rel="stylesheet" href="/css/inline-hyperlinks.css">
        <link rel="stylesheet" href="/css/step-cards.css">
        ...
        <figure>
          <div class="step-card" id="step-card-1">
            ...
            <div class="step-card-inner" id="step-card-inner-1">
              ...
              <div class="prompt-wrapper">
                <span>></span>
                <p>use <a href="https://github.com/praw-dev/praw">PRAW</a> to sort those submissions by current upvote status</p>
              </div>
            </div>
          </div>
          ...
          <div class="step-card" id="step-card-3">
            ...
            <div class="step-card-inner" id="step-card-inner-3">
              <div class="prompt-wrapper">
                <span>></span>
                <p>classify each article header from 12 possible labels using Meta's BART-based zero-shot text classification <a
                    href="https://huggingface.co/facebook/bart-large-mnli">model</a></p>
              </div>
            </div>
          </div>
        </figure>
